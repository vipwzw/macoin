...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { while (true) {
        ...
        LogPrintf("Running MacoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("MacoinMiner terminated\n");
        throw;
    }
}
