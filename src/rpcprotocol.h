...
std::string HTTPPGetUrl(const std::string& host, const std::string& url, const std::map<std::string,std::string>& params, const std::map<std::string,std::string>& mapRequestHeaders);
