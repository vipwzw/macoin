...
{
    BOOST_CHECK(TestSplitHost("www.macoin.org", "www.macoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.macoin.org]", "www.macoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.macoin.org:80", "www.macoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.macoin.org]:80", "www.macoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:10998", "127.0.0.1", 10998));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:10998", "127.0.0.1", 10998));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:10998", "::ffff:127.0.0.1", 10998));
    BOOST_CHECK(TestSplitHost("[::]:10998", "::", 10998));
    BOOST_CHECK(TestSplitHost("::10998", "::10998", -1));
    BOOST_CHECK(TestSplitHost(":10998", "", 10998));
    BOOST_CHECK(TestSplitHost("[]:10998", "", 10998));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:10998", "127.0.0.1:10998"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:10998", "[::]:10998"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
