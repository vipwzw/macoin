...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Macoin2
    // Mac: ~/Library/Application Support/Macoin
    // Unix: ~/.macoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Macoin2";
#else
    fs::path pathRet;
...
// Format the subversion field according to BIP 14 spec (https://en.macoin.it/wiki/BIP_0014)
